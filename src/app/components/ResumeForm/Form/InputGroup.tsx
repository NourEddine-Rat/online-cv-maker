...
export const INPUT_CLASS_NAME =
  "mt-1 px-3.5 py-2.5 block w-full rounded-lg border border-gray-200 text-gray-900 shadow-sm outline-none font-normal text-base transition-all duration-200 hover:border-gray-300 focus:border-indigo-400 focus:ring-2 focus:ring-indigo-100";
